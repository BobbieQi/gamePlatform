...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    function hideURLbar(){ window.scrollTo(100,220); } </script>
    <!-- //for-mobile-apps -->
...
<script type="text/javascript">
    function reloadcode() {
        ...
        verify.setAttribute("src", "${pageContext.request.contextPath}/verificationcodeimg.jsp?it=" + Math.random());
    }
</script>
<body>
<!-- header -->
    ...
    <div class="container">
        <div class="logo-nav">
            <div class="logo-nav-left animated wow slideInLeft">
                <h1><a href="${pageContext.request.contextPath}/index.jsp">重大电竞<span style="padding-top: 10px;">Have fun more</span></a>
                </h1>
            </div>
...
<div class="register">
    <div class="container">
        ...
        <form class="all-form-grids register-grids" action="${pageContext.request.contextPath}/user/registerresult.do"
              method="post">
            ...
            <div class="animated wow slideInUp" data-wow-delay=".5s">
                ...
                <input type="text" name="phonenumber" placeholder="手机号" required=" " >
                <div class="row">
                    <div class="col-md-7">
                        <input type="confirm" name="confirmcode" id="confirmlogo" placeholder="请输入验证码" required=" " >
                    </div>
...
<div class="footer">
    <div class="container">
        ...
        <div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
            <h2><a href="${pageContext.request.contextPath}/index.jsp">Best Store <span>shop anywhere</span></a></h2>
        </div>
