...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _uploadExtraOnly: function () {
            ...
            fnError = function (jqXHR, textStatus, errorThrown) {
                var outData = self._getOutData(jqXHR), op = self.ajaxOperations.uploadExtra,
                    errMsg = self._parseError(op, jqXHR, errorThrown);
                params.data = outData;
                self._showUploadError(errMsg, outData, 'filebatchuploadcomplete');
                self._setProgress(101, self.$progress, self.msgAjaxProgressError.replace('{operation}', op));
            };
            self._ajaxSubmit(fnBefore, fnSuccess, fnComplete, fnError);
        },
        ...
        _previewDefault: function (file, previewId, isDisabled) {
            ...
            if (isDisabled === true && self.isAjaxUpload) {
                self._setThumbStatus($('#' + previewId), 'Success');
            }
        },
        ...
        _renderFileFooter: function (caption, size, width, isError) {
            var self = this, config = self.fileActionSettings, rem = config.showRemove, drg = config.showDrag,
                ...
                title = isError ? config.indicatorSuccessTitle : config.indicatorNewTitle,
    ...
    $.fn.fileinput.defaults = {
        ...
        progressErrorClass: "progress-bar bg-success progress-bar-success",
